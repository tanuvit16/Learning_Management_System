...
const Testimonialsection = () => {
  return (
    ...
    <div className='pb-14 px-8 md:px-0 text-center'>
       <h2 className='text-5xl font-medium text-gray-800'>Testimonials</h2>
       ...
       {/* <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 mt-14 justify-items-center'> */}
       <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-14 max-w-6xl mx-auto'>
          ...
          <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
            <div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
              ...
              <div className='p-5 pb-7'>
                ...
                </div> <p className='text-gray-500 mt-5'>{testimonial.feedback}</p> </div>
