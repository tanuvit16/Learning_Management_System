...
const AddCourse = () => {
  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col md:p-8 p-4">
      ...
      <form>
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            value={courseTitle}
            onChange={(e) => setCourseTitle(e.target.value)}
            className="outline-none border border-gray-500 px-3 py-2 rounded"
            required
          />
        </div>
        ...
        <div className="mt-6">
          ...
          {chapters.map((chapter, chapterIndex) => (
            <div key={chapter.chapterId} className="border rounded mb-4 bg-white">
        ...
        <div
          ...
          className="bg-blue-100 p-2 rounded cursor-pointer w-fit"
        >
          + Add Chapter
        </div>
        ...
        <button
          type="submit"
          className="bg-black text-white py-2 px-8 rounded my-4"
        >
          ADD
        </button>
